...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "nileshrkdf" => "nileshrkdf@gmail.com" }
  # Or just: spec.author    = "nileshrkdf"
  # spec.authors            = { "nileshrkdf" => "nileshrkdf@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/nileshrkdf"
